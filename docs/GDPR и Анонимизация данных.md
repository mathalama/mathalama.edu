...
В Европейском Союзе соблюдение требований **GDPR (General Data Protection Regulation)** является обязательным. Одно из ключевых требований — **Right to be Forgotten (Право на забвение)**: пользователь имеет право потребовать полного удаления своих персональных данных (PII — Personally Identifiable Information).
...
## 5. Почему это решение идеальное для собеседований в ЕС?

Когда технический директор или тимлид на собеседовании спросит вас: *"Как вы подходите к защите персональных данных?"*, вы сможете продемонстрировать глубокое понимание темы:
1.  Вы понимаете разницу между `DELETE` и анонимизацией.
2.  Вы умеете использовать **событийную асинхронность** (Event-Driven) для тяжелых операций вроде удаления терабайтов файлов из S3, чтобы HTTP-ответ пользователю возвращался мгновенно.
3.  Вы знаете, как защитить БД от дубликатов с помощью salted-хэширования email, не нарушая приватность.
